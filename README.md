...
Existing global config files are not rewritten automatically. To use the current Codex default in an existing setup, update `models.codex` in `~/.config/git-sc/config.toml`.
